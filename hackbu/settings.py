"""
Django settings for hackbu project.
...
SECRET_KEY = 'fld1&=8brhy&inrp-x)r*epaog2i-v8agmsig#fo&6z7xisx^m'
...
ROOT_URLCONF = 'hackbu.urls'

WSGI_APPLICATION = 'hackbu.wsgi.application'
